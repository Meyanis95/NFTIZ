...
export class NFTStorage implements Service {
     ...
     */
    static storeBlob(service: Service, blob: Blob): Promise<CIDString>;
    /**
     ...
     * @returns {Promise<CIDString>}
     */
    static storeCar({ endpoint, token }: Service, car: Blob | CarReader, { onStoredChunk, maxRetries, decoders }?: import("./lib/interface.js").CarStorerOptions | undefined): Promise<CIDString>;
    /**
     ...
     * @returns {Promise<CIDString>}
     */
    static storeDirectory(service: Service, files: Iterable<File>): Promise<CIDString>;
    /**
     ...
     */
    static store<T_1 extends import("./lib/interface.js").TokenInput>(service: Service, metadata: T_1): Promise<import("./lib/interface.js").Token<T_1>>;
    /**
     ...
     */
    static status({ endpoint, token }: Service, cid: string): Promise<import('./lib/interface.js').StatusResult>;
    /**
     ...
     */
    static check({ endpoint }: import('./lib/interface.js').PublicService, cid: string): Promise<import('./lib/interface.js').CheckResult>;
    /**
     ...
     */
    static delete({ endpoint, token }: Service, cid: string): Promise<void>;
    /**
     ...
     */
    static encodeBlob(blob: Blob): Promise<{
        cid: CID;
        car: CarReader;
    }>;
    /**
     ...
     * @returns {Promise<{ cid: CID, car: CarReader }>}
     */
    static encodeDirectory(files: Iterable<File>): Promise<{
        cid: CID;
        car: CarReader;
    }>;
    /**
     ...
     * @param {Blob} blob
     */
    storeBlob(blob: Blob): Promise<import("./lib/interface.js").CIDString>;
    /**
     ...
     * @param {Iterable<File>} files
     */
    storeDirectory(files: Iterable<File>): Promise<import("./lib/interface.js").CIDString>;
    /**
     * Returns current status of the stored NFT by its CID. Note the NFT must
     * have previously been stored by this account.
     *
     ...
     * @param {string} cid
     */
    status(cid: string): Promise<import("./lib/interface.js").StatusResult>;
    /**
     ...
     * @param {string} cid
     */
    check(cid: string): Promise<import("./lib/interface.js").CheckResult>;
    /**
     * Stores the given token and all resources it references (in the form of a
     ...
     * @param {T} token
     */
    store<T extends import("./lib/interface.js").TokenInput>(token: T): Promise<import("./lib/interface.js").Token<T>>;
}
